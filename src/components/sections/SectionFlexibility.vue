<template>
  ...
  <Editor :lines="9">
    <template #input>
      <pre><code class="language-markdown">Incididunt <code class="language-markup"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>u</span> <span :class="step < 1 && 'highlight'"><span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>decoration-orange<span class="token punctuation">"</span></span></span><span class="token punctuation">&gt;</span></span>in amet<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>u</span><span class="token punctuation">&gt;</span></span> </code> est magna.
<span v-if="step > 0" id="step1" />
...
<span class="token list punctuation">-</span> Pariatur pariatur consectetur tempor duis ullamco mollit.<span v-if="step > 0" id="step2" /></code></pre>
    </template>
    <template #output>
      <div class="">
        <p class="mt-0">
