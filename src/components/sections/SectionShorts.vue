...
<template>
	...
	>
		<div class="max-w-screen-lg mx-auto">
			<h3 class="text-4xl leading-6 font-serif text-white mb-12">
				There's no reason to miss LaTeX – promised.
			</h3>
			<h3 class="mt-10 mb-4 text-2xl text-white">1. Edit</h3>
			<dl class="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-3">
				...
				<Card>
					...
					<template #title> File splitting </template>
					<template #content
						>Import separated content just with
						<InlineCode>&lt;FileName/&gt;</InlineCode>.</template
					>
				</Card>
				<Card>
					<template #icon>
			...
			<h3 class="mt-10 mb-4 text-2xl text-white">2. Extend</h3>
			<dl class="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-3">
				<Card>
					<template #icon>
						<IconExport />
			...
			<dl class="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-3">
				<Card>
					...
					<template #title> Local & private </template>
					<template #content
						>Everything runs on your own computer – no cloud, no
						tracking.</template
					>
				</Card>
				<Card>
					...
					<template #title> Versioning </template>
					<template #content>
						Plain text files and folders – everything works great
						with Git.
					</template>
				</Card>
				<Card>
					...
					<template #content
						>PDF, web export and Pandoc compatibility out of the
						box.</template
					>
				</Card>
			</dl>
